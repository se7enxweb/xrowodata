...
require_once 'Interfaces'.DIRECTORY_SEPARATOR.'Object.php';
require_once 'Azure'.DIRECTORY_SEPARATOR.'TableEntry.php';
require_once 'Azure'.DIRECTORY_SEPARATOR.'Tables.php';
require_once 'Resource'.DIRECTORY_SEPARATOR.'Messages.php';
require_once 'Common'.DIRECTORY_SEPARATOR.'Dictionary.php';
require_once 'Common'.DIRECTORY_SEPARATOR.'Collection.php';
require_once 'Context'.DIRECTORY_SEPARATOR.'EntityStates.php';
require_once 'Interfaces'.DIRECTORY_SEPARATOR.'Entity.php';
require_once 'Context'.DIRECTORY_SEPARATOR.'ResourceBox.php';
require_once 'Context'.DIRECTORY_SEPARATOR.'RelatedEnd.php';
require_once 'Context'.DIRECTORY_SEPARATOR.'SaveResult.php';
require_once 'Common'.DIRECTORY_SEPARATOR.'Guid.php';
require_once 'Common'.DIRECTORY_SEPARATOR.'ClientType.php';
require_once 'Common'.DIRECTORY_SEPARATOR.'ACSUtil.php';
require_once 'Common'.DIRECTORY_SEPARATOR.'AzureTableUtil.php';
require_once 'Common'.DIRECTORY_SEPARATOR.'ContentType.php';
require_once 'Credential'.DIRECTORY_SEPARATOR.'CredentialType.php';
require_once 'Credential'.DIRECTORY_SEPARATOR.'CredentialBase.php';
require_once 'Credential'.DIRECTORY_SEPARATOR.'AzureTableCredential.php';
require_once 'Credential'.DIRECTORY_SEPARATOR.'ACSCredential.php';
require_once 'Credential'.DIRECTORY_SEPARATOR.'WindowsCredential.php';
require_once 'Common'.DIRECTORY_SEPARATOR.'Utility.php';
require_once 'Context'.DIRECTORY_SEPARATOR.'DataServiceQueryContinuation.php';
require_once 'Context'.DIRECTORY_SEPARATOR.'QueryComponents.php';
require_once 'Context'.DIRECTORY_SEPARATOR.'QueryOperationResponse.php';
require_once 'Context'.DIRECTORY_SEPARATOR.'DataServiceQuery.php';
require_once 'Context'.DIRECTORY_SEPARATOR.'DataServiceStreamResponse.php';
require_once 'Context'.DIRECTORY_SEPARATOR.'DataServiceRequestArgs.php';
require_once 'Context'.DIRECTORY_SEPARATOR.'SaveChangesOptions.php';
require_once 'Context'.DIRECTORY_SEPARATOR.'DataServiceSaveStream.php';
require_once 'Context'.DIRECTORY_SEPARATOR.'ContentStream.php';
require_once 'Context'.DIRECTORY_SEPARATOR.'DataServiceResponse.php';
require_once 'Context'.DIRECTORY_SEPARATOR.'OperationResponse.php';
require_once 'Parser'.DIRECTORY_SEPARATOR.'AtomParser.php';
require_once 'WebUtil'.DIRECTORY_SEPARATOR.'HttpBatchRequest.php';
require_once 'WebUtil'.DIRECTORY_SEPARATOR.'HttpBatchResponse.php';
require_once 'WebUtil'.DIRECTORY_SEPARATOR.'HttpRequest.php';
require_once 'WebUtil'.DIRECTORY_SEPARATOR.'Microsoft_Http_Response.php';
require_once 'WebUtil'.DIRECTORY_SEPARATOR.'HttpResponse.php';
require_once 'WebUtil'.DIRECTORY_SEPARATOR.'HttpRequestHeader.php';
require_once 'WebUtil'.DIRECTORY_SEPARATOR.'HttpVerb.php';
require_once 'Common'.DIRECTORY_SEPARATOR.'HttpProxy.php';
require_once 'Exception'.DIRECTORY_SEPARATOR.'ODataServiceException.php';
require_once 'Exception'.DIRECTORY_SEPARATOR.'DataServiceRequestException.php';
require_once 'Exception'.DIRECTORY_SEPARATOR.'InvalidOperation.php';
require_once 'Exception'.DIRECTORY_SEPARATOR.'ACSUtilException.php';
require_once 'Exception'.DIRECTORY_SEPARATOR.'InternalError.php';
